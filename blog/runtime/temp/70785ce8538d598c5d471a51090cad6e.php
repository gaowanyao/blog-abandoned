<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:91:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/index/article_picture.html";i:1500141128;s:83:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/header.html";i:1500141129;s:81:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/left.html";i:1500141129;s:90:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/quick_sidebar.html";i:1500141129;s:83:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/footer.html";i:1500141128;s:86:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/quick_nav.html";i:1500141129;}*/ ?>
<!DOCTYPE html>
...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item start  <?php if('picture' == 'article'){ echo ' active open';} ?>">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start  <?php if('article_picture' == 'article'){ echo ' active open';} ?>">
                        <a href="article" class="nav-link ">
                            <i class="icon-bar-chart"></i>
                            <span class="title">文章列表</span>
                        </a>
                    </li>
                    <li class="nav-item start   <?php if('article_picture' == 'add_article'){ echo ' active open';} ?>">
            ...
            <li class="nav-item  <?php if('picture' == 'picture'){ echo ' active open';} ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    <li class="nav-item  <?php if('article_picture' == 'article_picture'){ echo ' active open';} ?>">
                        ...
                        <div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-green bold uppercase">文章图片</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="mt-element-card mt-element-overlay">
                                    <div class="row">
                                        ...
                                        <?php if(is_array($article_picture) || $article_picture instanceof \think\Collection || $article_picture instanceof \think\Paginator): $i = 0; $__LIST__ = $article_picture;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>

                                        <input type="text" style="width: 50px;position: absolute;left: -10000px;" id="mt-target-<?php echo $vo['id']; ?>" class="form-control" value="<?php echo $vo['article_picture']; ?>" />
                                            ...
                                            <div class="mt-card-item">
                                                <div class="mt-card-avatar mt-overlay-1">
                                                    <img style="width: 100%;min-width: 205px;height: 175px;min-height: 175px;" src="<?php if($vo['article_picture'] == ''){ echo 'http://www.placehold.it/205x175/EFEFEF/AAAAAA&amp;text=no+image';}else{echo $vo['article_picture'];} ?>" />

                                                    <div class="mt-overlay">
                                                        <ul class="mt-info">
                                                            <li>
                                                                <a class="btn default btn-outline" href="/blog/public/admin/index/article_picture_path?id=<?php echo $vo['id']; ?>">
                                                                    <i class="icon-magnifier"></i>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="btn default btn-outline mt-clipboard"  data-clipboard-action="copy" data-clipboard-target="#mt-target-<?php echo $vo['id']; ?>">
                                                                    <i class="icon-link"></i>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <a href="/blog/public/admin/index/update_article?id=<?php echo $vo['id']; ?>" style="text-decoration: none;"><h3 class="mt-card-name" style="text-decoration: none;width:90%;margin:0 auto;margin-bottom: 10px;overflow:hidden;word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;"><?php echo $vo['title']; ?></h3></a>
                                                <!--<p class="mt-card-desc font-grey-mint" style="text-decoration: none;width:90%;margin:0 auto;overflow:hidden;word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;"><?php echo $vo['title']; ?></p>-->
...
<script src="__STATIC__/assets/global/plugins/clipboardjs/clipboard.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="__STATIC__/assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="__STATIC__/assets/pages/scripts/components-clipboard.min.js" type="text/javascript"></script>
    ...
    var TableDatatablesButtons = function () {
        ...
        var initAjaxDatatables = function () {
            ...
            grid.init({
                ...
                loadingMessage: 'Loading__STATIC__.',
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "__STATIC__/demo/table_ajax.php", // ajax source
                    },
                    "order": [
                        [1, "asc"]
