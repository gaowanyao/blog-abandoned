<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:90:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/index/update_article.html";i:1500141128;s:83:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/header.html";i:1500141129;s:81:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/left.html";i:1500141129;s:90:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/quick_sidebar.html";i:1500141129;s:83:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/footer.html";i:1500141128;s:86:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/quick_nav.html";i:1500141129;}*/ ?>
<!DOCTYPE html>
...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item start  <?php if('article' == 'article'){ echo ' active open';} ?>">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item start   <?php if('article' == 'add_article'){ echo ' active open';} ?>">
            ...
            <li class="nav-item  <?php if('article' == 'picture'){ echo ' active open';} ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    <li class="nav-item  <?php if('article' == 'article_picture'){ echo ' active open';} ?>">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="update_article_msg" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                    <div class="form-body">
                                        ...
                                        <input type="text"  name="time" value="<?php echo $article['content']; ?>" hidden>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input value="<?php echo $article['title']; ?>" type="text" class="form-control" maxlength="100" name="title" id="title" placeholder="请输入标题">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input  value="<?php echo $article['author']; ?>" type="text" class="form-control" maxlength="100" name="author" id="author" placeholder="请输入作者">
