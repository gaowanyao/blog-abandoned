<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:81:"/home/wwwroot/www.gcan.top/blog/public/../application/index/view/index/index.html";i:1501725901;s:83:"/home/wwwroot/www.gcan.top/blog/public/../application/index/view/Public/header.html";i:1501726514;s:88:"/home/wwwroot/www.gcan.top/blog/public/../application/index/view/Public/index_right.html";i:1500141130;s:90:"/home/wwwroot/www.gcan.top/blog/public/../application/index/view/Public/quick_sidebar.html";i:1500141131;s:83:"/home/wwwroot/www.gcan.top/blog/public/../application/index/view/Public/footer.html";i:1501723915;s:86:"/home/wwwroot/www.gcan.top/blog/public/../application/index/view/Public/quick_nav.html";i:1500141131;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="page-wrapper-top">
            ...
            <div class="container">
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li style="<?php if($switch == 'off'){ echo 'display:none'; }?>" class="dropdown dropdown-extended dropdown-inbox dropdown-dark" id="header_inbox_bar">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        ...
                        <li  style="<?php if($switch == 'on'){ echo 'display:none'; }?>" class="dropdown dropdown-extended dropdown-inbox dropdown-dark" >
                            <a href="/blog/public/index/index/signin" class="dropdown-toggle" >
                                登录
                            </a>
                        ...
                        <li style="<?php if($switch == 'on'){ echo 'display:none'; }?>" class="dropdown dropdown-extended dropdown-inbox dropdown-dark" >
                            <a href="/blog/public/index/index/signup" class="dropdown-toggle" >
                               注册
                            </a>
                        ...
                        <li style="<?php if($switch == 'off'){ echo 'display:none'; }?>" class="dropdown dropdown-user dropdown-dark">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <img alt="" class="img-circle" src="__STATIC__/img/kaola.jpg">
        ...
        <div class="page-header-menu">
            <div class="container">
                ...
                <form class="search-form" action="/blog/public/index/index/search" method="GET">
                ...
                <div class="hor-menu  ">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-dropdown mega-menu-dropdown"  style="display: none;">
                        ...
                        <li  style="display: none;" class="menu-dropdown classic-menu-dropdown ">
                        ...
                        <li style="display: none;" class="menu-dropdown mega-menu-dropdown  mega-menu-full">
                        ...
                        <li style="display: none;" class="menu-dropdown classic-menu-dropdown active">
                            <a href="javascript:;">
                                               ...
                                               <div class="blog-post-lg bordered blog-container">
                                                    ...
                                                    <div class="blog-post-content">
                                                        <h2 class="blog-title blog-post-title">
                                                            <a href="/blog/public/index/index/single_page?cc=<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></a>
                                                        </h2>

                                                        <div class="row">
                                                            <div class="blog-img-thumb col-lg-3" style="height: 173px;">
                                                                <a href="/blog/public/index/index/single_page?cc=<?php echo $vo['id']; ?>">
                                                                    <!--<img style="height: 153px;" src="__STATIC__/assets/pages/img/page_general_search/4.jpg" />-->
                                                                    <img style="width: 100%;height: 100%;" src="<?php echo $vo['article_picture']; ?>" onerror="javascript:this.src='__STATIC__/img/kaola.jpg';" class="JIATHIS_IMG_OK" />
                                                                    <!--<img style="width: 100%;height: 100%;" src="__STATIC__/img/kaola.jpg" />-->

                                                                </a>
                                                            </div>

                                                            <div class="blog-post-desc col-lg-9" style="margin-top:-10px;height: 159px !important;overflow:hidden;">


                                                                <?php

                                                              echo file_get_contents(ROOT_PATH."public/static/article/".$vo['content'].".html");
                                                        ...
                                                        <p style="text-align: right;display: inherit;margin-top: 5px;margin-right: 5px;">
                                                            <a href="/blog/public/index/index/single_page?cc=<?php echo $vo['id']; ?>" class="btn blue">
                                                            ...
                                                            for($i=0;$i<count($arr);$i++){
                                                                if($arr[$i] == ''){}else{
                                                                    $str .= "<li class='uppercase'>
                                                                                             <a href='/blog/public/index/index/tag?tag=".$arr[$i]."'>".$arr[$i]."</a>
                                                                                        </li>";
                                                                        }
                                                                   }
                                                                        echo $str;
        ...
        <div class="col-sm-12">
            <div class="blog-quote bordered blog-container">
                ...
                <div class="blog-quote-avatar">
                    <a href="javascript:;">
                        <img src="__STATIC__/img/ayaotx.jpg" />
                    </a>
                </div>
            ...
            <div class="blog-post-sm bordered blog-container">
                <div class="blog-img-thumb">
                    <a href="/blog/public/index/index/single_page?cc=<?php echo $vo['id']; ?>">
                        ...
                        <img style="width: 100%;height: 100%;" src="<?php if($vo['article_picture']!=''){echo $vo['article_picture']; }else{ echo '__STATIC__/img/kaola.jpg';}?>" onerror="javascript:this.src='__STATIC__/img/kaola.jpg';" />
    ...
    <div class="page-quick-sidebar">
        ...
        <div class="tab-content">
            <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                    ...
                    <ul class="media-list list-items">
                        <li class="media">
                            ...
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar3.jpg" alt="...">
                        ...
                        <li class="media">
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar1.jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar4.jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar2.jpg" alt="...">
                            <div class="media-body">
                    ...
                    <ul class="media-list list-items">
                        <li class="media">
                            ...
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar6.jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar7.jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar8.jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar9.jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar10.jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="__STATIC__/assets/layouts/layout/img/avatar11.jpg" alt="...">
                            <div class="media-body">
                ...
                <div class="page-quick-sidebar-item" style="width:100%;">
        ...
        <div class="page-prefooter">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                        <h2>Contacts</h2>
                        <address class="margin-bottom-40"> WeChat: gw1528667112
                            <br> Email:
                            <a href="mailto:info@metronic.com">1528667112@qq.com</a>
                        </address>
                    </div>
                </div>
            </div>
