<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:87:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/index/add_article.html";i:1500141127;s:83:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/header.html";i:1500141129;s:81:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/left.html";i:1500141129;s:90:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/quick_sidebar.html";i:1500141129;s:83:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/footer.html";i:1500141128;s:86:"/home/wwwroot/www.gcan.top/blog/public/../application/admin/view/Public/quick_nav.html";i:1500141129;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item start  <?php if('article' == 'article'){ echo ' active open';} ?>">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start  <?php if('add_article' == 'article'){ echo ' active open';} ?>">
                        <a href="article" class="nav-link ">
                            <i class="icon-bar-chart"></i>
                            <span class="title">文章列表</span>
                        </a>
                    </li>
                    <li class="nav-item start   <?php if('add_article' == 'add_article'){ echo ' active open';} ?>">
            ...
            <li class="nav-item  <?php if('article' == 'picture'){ echo ' active open';} ?>">
                ...
                <ul class="sub-menu">
                    <li class="nav-item  <?php if('add_article' == 'article_picture'){ echo ' active open';} ?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light form-fit bordered">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="add_article_msg" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" maxlength="100" name="title" id="title" placeholder="请输入标题">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" maxlength="100" name="author" id="author" placeholder="请输入作者">
